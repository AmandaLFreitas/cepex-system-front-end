  ...
  const approvalFlow = [
    {
      ...
      role: "Professor",
      description:
        "Professor propõe um evento com todos os detalhes necessários",
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-2">
                  Fluxo de revisão e aprovação para todos os Atividades
                  institucionais.
                </p>
              </div>
            </div>
                    ...
                    <tbody>
                      {pendingApprovals.map((approval, index) => (
                        <tr key={index} className="border-b border-border">
                          ...
                          <td className="p-4">
                            <span
                              className={`px-3 py-1 rounded-full text-xs font-medium ${approval.statusColor}`}
                            >
                              {approval.status}
                            </span>
                          </td>
